...
class Lib {
	...
	function kirimemail($email="", $subject="", $isi=""){
		...
		$ci->email->to($email);
		// $ci->email->cc('eproc@jmto.co.id');
		$ci->email->cc('procurement@jmto.co.id');
		...
		switch($type){
			case "js":
				...
				switch($p1){
					...
					case "main":
						$arrayjs = [
							'__assets/plugin/template/bower_components/jquery/dist/jquery.min.js',
							'__assets/plugin/template/bower_components/bootstrap/dist/js/bootstrap.min.js',
							
							'__assets/plugin/template/bower_components/jquery-slimscroll/jquery.slimscroll.min.js',
							'__assets/plugin/template/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js',
							'__assets/plugin/template/adminlte/js/adminlte.min.js',
							'__assets/plugin/easyui/jquery.easyui.min.js',
							'__assets/plugin/jquery-validation/dist/jquery.validate.js',
							'__assets/plugin/formwizard/wizard.js',
							'__assets/js/fungsi.js',
							'__assets/js/blockui.js',
						];
					break;
				}
				...
				switch($p1){
					...
					case "main":
						$arraycss = [
							...
							'__assets/plugin/template/dist/css/AdminLTE.min.css',
							'__assets/plugin/template/dist/css/skins/_all-skins.min.css',
							'__assets/plugin/formwizard/wizard.css',
						];
					break;
				}
