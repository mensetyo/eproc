       ...
       <div class="col-lg-12">
			...
			<table class="table">
				...
				<tr>
					...
					<td>:</td>
					<td>Pemasukan Dokumen Penawaran Harga </td>
				</tr>
				<tr>
					<td style="width:200px;">Tgl Awizing</td>
					<td>:</td>
					<td><b>{$projek.tgl_anwijing}</b></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="width:300px;">Dokumen Penawaran Harga</td>
					<td>:</td>
					<td>
						<p>
						...
						<table class="table">
							...
							<tr>
								...
								<td style="width:10px;">:</td>
								<td>{if !$penawaran}<input type="text" name="nilai_penawaran" id="nilai_penawaran_{$acak}" class="angka" style="height:33px;font-weight:bold;">{else}{$penawaran.nilai_penawaran|number_format:2:',':'.'|default:''} (Menunggu Evaluasi Panitia){/if}</td>
							</tr>
							<tr>
								<td style="width:200px;">File Penawaran Harga</td>
								<td style="width:10px;">:</td>
				...
				<tr>
					<td colspan="3">
						<p>
							* Penawaran berada didalam satu file yang berisi :<br>
								&nbsp;&nbsp;&nbsp;&nbsp;1. Surat Penawaran <br>
								&nbsp;&nbsp;&nbsp;&nbsp;2. DKH (Daftar Kuantitas Harga)<br>
								&nbsp;&nbsp;&nbsp;&nbsp;3. Analisa Harga Satuan<br>
								Sesuai dengan format dokumen lelang.<br>
							<br>
