    <section id="beranda" class="home-section paddingbot-60">
      ...
      <div class="container">
       <div class="col-lg-12">
			<form class="form-horizontal" id="form_{$acak}" url="{$host}KirimPenawaran1" method="post" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<tr>
					...
					<td>:</td>
					<td>Pemasukan Dokumen Administrasi & Teknis </td>
				</tr>
				<tr>
				...
				<tr>
					<td style="width:300px;">Penawaran Dokumen Administrasi & Teknis</td>
					<td>:</td>
					<td>
						<p>
						...
						<table class="table">
							...
							<tr>
								<td style="width:200px;">File Penawaran Administrasi & Teknis</td>
								<td style="width:10px;">:</td>
