    <section id="beranda" class="home-section paddingbot-60">
      ...
      <div class="container">
       <div class="col-lg-12">
			<form class="form-horizontal" id="form_{$acak}" url="{$host}KirimPenawaran" method="post" enctype="multipart/form-data">
			...
			<table class="table">
				...
				<tr>
					<td style="width:200px;">Penawaran Anda</td>
					<td>:</td>
					<td>
						<p>
						...
						<table class="table">
							...
							<tr>
								<td style="width:200px;">File Penawaran</td>
								<td style="width:10px;">:</td>
				...
				<tr>
					<td colspan="3">
						<p>
							* Penawaran berada didalam satu file<br>
