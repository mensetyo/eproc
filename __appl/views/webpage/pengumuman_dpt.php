...
<link rel="stylesheet" href="{$host}__assets/webpage/css/style.css" media="screen" type="text/css" />
...
<body bgcolor="white" id="page-top" data-spy="scroll" data-target=".navbar-custom" onload="startgame();">

	<div id="wrapper">
		  {include file="webpage/include/daftar.php"}
		  {include file="webpage/include/menu1.php"}
		  {include file="webpage/sec_pengumuman_dpt.php"}
