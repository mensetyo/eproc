                        ...
                        <div class='col-md-12'>
                            ...
                            <div class='box box-info'>
                                <div class='box-header'>
                                  ...
                                  <form method="post" action="<?php echo base_url('admin_agenda/simpan');?>"  >
								  <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
								  
								  			<div class='box-body pad'>
							
										       <label for="exampleInputEmail1">Tanggal</label>
                                            <input type="text" class="form-control" id="tgl" name="tgl" value="<?php echo $tgl; ?>" placeholder="">
                                        </div>
										...
										<div class='box-body pad'>
                                            ...
                                            <input type="text" class="form-control" id="agenda" name="agenda" value="<?php echo $agenda; ?>" placeholder="">
                                        </div>
