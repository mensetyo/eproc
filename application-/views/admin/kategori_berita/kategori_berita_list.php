...
<?php $this->load->view('admin/include/sidemenu');?>
                                                ...
                                                <td width="120px">
													<div class="btn-group">
														...
														<ul class="dropdown-menu" role="menu">
															<li><a href="<?php echo base_url('konfigurasi/kategori_berita/delete/');?><?php echo $row->id;?>" onclick="return confirm('Apakah Anda Yakin untuk hapus data ini ?');">Delete</a></li>
															<li><a href="<?php echo base_url('konfigurasi/kategori_berita_form/');?><?php echo $row->id;?>">Edit</a></li>
														</ul>
													</div>
												</td>
                                            </tr>
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('konfigurasi/kategori_berita/form')?>";
			});
