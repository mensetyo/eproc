...
<html>
    <head>
        ...
        <![endif]-->
    <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/87B0C517-72DD-DB4B-92B5-5B992819F329/main.js" charset="UTF-8"></script></head>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Info Perusahaan</li>
                    </ol>
                </section>
                        ...
                        <div class='col-md-12'>
                            ...
                            <div class='box box-info'>
                                <div class='box-header'>
                                  ...
                                  <form method="post" action="<?php echo base_url('admin_info_perusahaan/simpan');?>">
								<div class='box-body pad'>
                                  
                                        <textarea id="editor1" name="editor1" rows="10" cols="80">
                                           <?php echo $info_perusahaan; ?>
                                        </textarea>                        
