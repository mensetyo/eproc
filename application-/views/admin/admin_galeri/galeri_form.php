                        ...
                        <div class='col-md-12'>
                            ...
                            <div class='box box-info'>
                                <div class='box-header'>
                                  ...
                                  <form method="post" action="<?php echo base_url('admin_galeri/simpan');?>"  enctype="multipart/form-data">
								  <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
										<div class='box-body pad'>
							
										       <label for="exampleInputEmail1">Description</label>
                                            <input type="text" class="form-control" id="description" name="description" value="<?php echo $description; ?>" placeholder="">
                                        </div>
										  ...
										  if($gambar<>""){
											  ?>
											<img src="<?php echo base_url();?>uploads/galeri/<?php echo $gambar; ?>" width="70px" height="70px"><?php echo $gambar; ?>
											<?php
										  }
										  ?>
										</div>
