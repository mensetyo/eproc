                                                ...
                                                <td width="120px">
													<div class="btn-group">
														...
														<ul class="dropdown-menu" role="menu">
															<li><a href="<?php echo base_url('admin_hubungi_kami/delete/');?><?php echo $row->id;?>" onclick="return confirm('Apakah Anda Yakin untuk hapus data ini ?');">Delete</a></li>
															<li><a href="<?php echo base_url('admin_hubungi_kami/view/');?><?php echo $row->id;?>">View</a></li>
														</ul>
													</div>
												</td>
                                            </tr>
