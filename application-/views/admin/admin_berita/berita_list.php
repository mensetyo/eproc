...
<?php $this->load->view('admin/include/sidemenu');?>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
										...
										<?php
											foreach ($query->result() as $row)
												{
													$query = $this->db->query("select * from t_berita_kategori where id='".$row->kategori_id."'");
										...
										?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->approved==1?'&#x2705;':'x';?></td>
                                                <td width="120px">
													<div class="btn-group">
														...
														<ul class="dropdown-menu" role="menu">
															<li><a href="<?php echo base_url('admin_berita/delete/');?><?php echo $row->id;?>" onclick="return confirm('Apakah Anda Yakin untuk hapus data ini ?');">Delete</a></li>
															<li><a href="<?php echo base_url('admin_berita/view/');?><?php echo $row->id;?>">View</a></li>
															<li><a href="<?php echo base_url('admin_berita/form/');?><?php echo $row->id;?>">Edit</a></li>
															<?php
															if($row->approved==0){
															?>
															<li><a href="<?php echo base_url('admin_berita/approved/');?><?php echo $row->id;?>">Approved</a></li>
															<?php
															}else{
															?>
															<li><a href="<?php echo base_url('admin_berita/undoapproved/');?><?php echo $row->id;?>">Undo Approved</a></li>
															<?php
															}
															?>
														</ul>
		...
		<script type="text/javascript">
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('admin_berita/form')?>";
			});
