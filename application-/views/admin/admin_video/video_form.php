                        ...
                        <div class='col-md-12'>
                            ...
                            <div class='box box-info'>
                                <div class='box-header'>
                                  ...
                                  <form method="post" action="<?php echo base_url('admin_video/simpan');?>"  enctype="multipart/form-data">
								  <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
										<div class='box-body pad'>
										  ...
										  if($video<>""){
											  ?>
											<img src="<?php echo base_url();?>uploads/video/<?php echo $gambar; ?>" width="70px" height="70px"><?php echo $video; ?>
											<?php
										  }
										  ?>
										</div>
