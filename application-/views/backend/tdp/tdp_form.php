                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" id="tdp" method="post" action="<?php echo base_url('tdp/simpan');?>" enctype="multipart/form-data">
                    ...
                    <h3>TDP </h3>
								...
								<div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" class="form-control" name="instansi_penerbit" id="instansi_penerbit" value="" autocomplete="off"/>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">5. Kegiatan Usaha Pokok</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="kegiatan_usaha_pokok" id="kegiatan_usaha_pokok" rows="5" autocomplete="off"><?php  echo $kegiatan_usaha_pokok;?></textarea>
