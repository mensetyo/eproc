                                    ...
                                    <table class="table datatable">
										...
										<?php
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                <td width="120px"> <a href="<?php echo base_url('sbu/hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('sbu/form/'.$row->id);?>"> Edit</a></td>
													</tr>
													  <?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('sbu/form')?>";
			});
