	...
	$().ready(function() {
		...
		$("#sbu").validate({
			...
			messages: {
				...
				tgl_terbit: "Wajib di isi",
				masa_berlaku: "Wajib di isi",
                <?php
				if($file==""){
				?>
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" id="sbu" method="post" action="<?php echo base_url('sbu/simpan');?>" enctype="multipart/form-data">
                            ...
                            <div class="page-title">                    
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">2. Instansi Penerbit  *</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" class="form-control" name="instansi_pemberi" id="instansi_pemberi" value="<?=$instansi_pemberi;?>" autocomplete="off"/>
                                        </div>
                                    </div>
									...
									<div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">4. Masa Berlaku *</label>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                <input type="text" class="form-control datepicker" name="masa_berlaku" id="masa_berlaku" value="<?=$masa_berlaku;?>" autocomplete="off">                                            
                                            </div>
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">5. Upload  * </label>
                                        <div class="col-md-6 col-xs-12">                                                                                                                                        
                                  ...
                                  <!-- <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">6. Kompetensi & Kualifikasi</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                          <table border="1" width="100%">
                                              <tr>
                                              <td align="center">No</td>
                                                    <td align="center">Subkode Bidang</td>
                                                    <td align="center">Sub Bidang</td>
                                                    <td align="center">Kualifikasi</td>
                                              </tr>
                                              <tr>
                                                  <td align="center">1</td>
                                                  <td><input type="text" class="form-control" name="masa_berlaku" id="masa_berlaku" value="" autocomplete="off"> </td>
                                                  <td><input type="text" class="form-control" name="masa_berlaku" id="masa_berlaku" value="" autocomplete="off"> </td>
                                                  <td><input type="text" class="form-control" name="masa_berlaku" id="masa_berlaku" value="" autocomplete="off"> </td>
                                              </tr>
                                              <tr>
