                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
										...
										<?php
                                                ...
                                                <td><?php echo  "Rp " . number_format($row->uraian_3,2,',','.');?></td>
                                                <td><?php echo  "Rp " . number_format($row->uraian_4,2,',','.');?></td>
                                                <td><?php echo  "Rp " . number_format($row->uraian_5,2,',','.');?></td>
                                                <td><?php echo  "Rp " . number_format($row->uraian_6,2,',','.');?></td>
                                                <td><?php echo  "Rp " . number_format($row->uraian_7,2,',','.');?></td>
