                                    ...
                                    <table class="table datatable">
										...
										<?php
											 ...
											 <tr>
                                                ...
                                                <td><?php echo  $row->masa_pajak_tahunan;?></td>
                                                <td><?php echo  $row->no_bkti_penerimaan_srt;?></td>
                                                <td>
                                                <?php echo  date('d-m-Y', strtotime($row->tgl_bkt_penerimaan_srt));?>
                                                </td>
                                                <td>
                                                <?php
                                                if($row->dok<>""){
                                                ?>
                                                <a href="#" onclick="PopupCenter('<?php echo base_url('uploads/pajak/'.$row->dok); ?>','xtf','1000','700')">Lihat</a>  
                                                <?php
                                                }else{
                                                ?>
                                                    x
                                                ...
                                                <td width="120px"><a href="<?php echo base_url('pajak/hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('pajak/form/'.$row->id);?>"> Edit</a></td>
											</tr>
													  <?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('pajak/form')?>";
			});
