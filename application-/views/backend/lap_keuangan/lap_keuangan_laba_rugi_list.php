...
<html lang="en">
    <head>
        ...
        <?php $this->load->view('include/backend/header'); ?>
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Laporan keuangan (Laba Rugi)</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">
                    <h3>Laporan keuangan (Laba Rugi)</h3>
                </div>
                <!-- END PAGE TITLE -->
                                    ...
                                    <table class="table datatable">
										...
										<?php
											...
											?>
                                                ...
                                                <td><?php echo  $row->laba_bruto;?></td>
                                                <td><?php echo  $row->beban_operasional;?></td>
                                                <td width="120px"> <a href="<?php echo base_url('lap_keuangan/laba_rugi_hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('lap_keuangan/index/'.$row->id);?>"> Edit</a></td>
													</tr>
										<?php
												   }
												}
