                                    ...
                                    <table class="table datatable">
										...
										<?php
                                                ...
                                                if($row->dok<>""){
                                                    ?>
                                                <td>
                                                    <a href="#" onclick="PopupCenter('<?php echo base_url('uploads/pengurus/'.$row->dok); ?>','xtf','1000','700')">Lihat</a>
                                                </td>
                                               <?php
                                                }else{
                                                ?>
                                                ...
                                                <td width="120px"> <a href="<?php echo base_url('pengurus/hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('pengurus/form/'.$row->id);?>"> Edit</a></td>
													</tr>
													  <?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('pengurus/form')?>";
			});
