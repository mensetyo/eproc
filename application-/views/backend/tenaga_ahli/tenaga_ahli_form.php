                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" id="tenaga_ahli" action="<?php echo base_url('tenaga_ahli/simpan');?>" enctype="multipart/form-data">
...
<input type="hidden" name="id" id="id" value="<?php echo $id;?>" >
	...
	<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">16. Dokumen </label>
                                        <div class="col-md-6 col-xs-12">                                                                                                                                      
