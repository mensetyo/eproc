                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
										...
										<?php
                                                ...
                                                <td><?php echo  date('d-m-Y', strtotime($row->berlaku_sampai));?>
                                                </td>
                                                ...
                                                if($row->dok<>""){
                                                    ?>
                                                <td>
                                                    <a href="#" onclick="PopupCenter('<?php echo base_url('uploads/ijin_usaha/'.$row->dok); ?>','xtf','1000','700')">Lihat</a>  
                                                </td>
                                               <?php
                                                }else{
                                                ?>
                                                ...
                                                ?>
                                                <td width="120px"> <a href="<?php echo base_url('ijin_usaha/hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('ijin_usaha/form/'.$row->id);?>"> Edit</a></td>
													</tr>
													  <?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('ijin_usaha/form')?>";
			});
