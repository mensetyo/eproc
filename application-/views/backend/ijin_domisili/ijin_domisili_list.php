                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
										...
										<?php
                                                ...
                                                <td><?php echo  date('d-m-Y', strtotime($row->tgl_terbit));?>
                                                <td><?php echo  date('d-m-Y', strtotime($row->tgl_sampai));?>
                                                </td>
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                <td width="120px"> <a href="<?php echo base_url('ijin_domisili/hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('ijin_domisili/form/'.$row->id);?>"> Edit</a></td>
													</tr>
													  <?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('ijin_domisili/form')?>";
			});
