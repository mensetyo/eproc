...
<script src="<?=base_url('assets')?>/lib/additional-methods.min.js"></script>
 ...
 <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  <script>
  $( function() {
    $( "#tgl_terbit" ).datepicker({ dateFormat: 'yy-mm-dd' });
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" id="domisili" method="post" action="<?php echo base_url('ijin_domisili/simpan');?>" enctype="multipart/form-data">
							...
							<div class="panel panel-default">
								...
								<div class="form-group">
									...
									<div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">3. Tgl Terbit *</label>
                                    ...
                                    <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">4. Berlaku S/d  *</label>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
