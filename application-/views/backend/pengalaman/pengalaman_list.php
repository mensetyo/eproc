                                ...
                                <div class="panel-body">
                                    <table class="table datatable">
										...
										<?php
                                                ...
                                                <td align="right"><?php echo  $row->persen_sharing;?></td>
                                               <?php
                                                if($row->file<>""){
                                                ?>
                                                <td>
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                 ...
                                                 <!--   <td><a href="<?php echo base_url('uploads/akta/'.$row->file); ?>">Lihat</a></td>-->

                                                <td width="120px"> <a href="<?php echo base_url('pengalaman/hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('pengalaman/form/'.$row->id);?>"> Edit</a></td>
													</tr>
													  <?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('pengalaman/form')?>";
			});
