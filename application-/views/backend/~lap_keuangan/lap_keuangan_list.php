...
<html lang="en">
    <head>
        ...
        <?php $this->load->view('include/backend/header'); ?>
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Laporan keuangan (Aktiva dan Passiva)</li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">
                    <h3>Laporan keuangan (Aktiva dan Passiva)</h3>
                </div>
                <!-- END PAGE TITLE -->
                                    ...
                                    <table class="table datatable">
										...
										<?php
											...
											?>
                                                ...
                                                <td><?php echo  $row->total_aktiva;?></td>
                                                <td><?php echo  $row->total_passiva;?></td>
                                                <td width="120px"> <a href="<?php echo base_url('lap_keuangan/aktiva_passiva_hapus/'.$row->id);?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')">Delete </a>|<a href="<?php echo base_url('lap_keuangan/index/'.$row->id);?>"> Edit</a></td>
													</tr>
										<?php
												   }
												}
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript">
			...
			$("#tambah").click(function() {
				  window.location.href = "<?php echo base_url('lap_keuangan/index')?>";
			});
