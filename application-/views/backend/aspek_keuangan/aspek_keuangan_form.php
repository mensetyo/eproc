                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post"  id="aspek_keuangan" action="<?php echo base_url('aspek_keuangan/simpan');?>" enctype="multipart/form-data">
                            <div class="panel panel-default">
								...
								<div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">9. Dokumen </label>
                                        <div class="col-md-6 col-xs-12">                                                                                                                              
