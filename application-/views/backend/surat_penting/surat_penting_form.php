...
<!--	
 <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  $( function() {
    ...
    $( "#masa_berlaku" ).datepicker({ dateFormat: 'dd-mm-yy' });
  } );
  </script>-->
        ...
        <?php $this->load->view('include/backend/header'); ?>
               ...
               <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    ...
                    <li class="active">Surat Penting</li>
                </ul>
                <!-- END BREADCRUMB -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" id="ijin_usaha" method="post" action="<?php echo base_url('surat_penting/simpan');?>" enctype="multipart/form-data">
                    ...
                    <h3>SURAT PENTING</h3>
								...
								<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">1. Jenis  * </label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" class="form-control" name="jenis" id="jenis"  value="" autocomplete="off"/>
                                        </div>
                                    </div>
									
									<div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">2. Nomor  *</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" class="form-control" name="nomor" id="nomor" value="" autocomplete="off"/>
                                        </div>
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">3. Instansi Pemberi  *</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <input type="text" class="form-control" name="instansi_pemberi" id="instansi_pemberi" value="" autocomplete="off"/>
                                        </div>
                                    </div>
									...
									<div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">4. Tanggal Terbit *</label>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                <input type="text" class="form-control datepicker" name="tgl_terbit" id="tgl_terbit" value="" autocomplete="off">                                            
                                            </div>
									...
									<div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">5. Tanggal Masa Berlaku *</label>
                                        <div class="col-md-3 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                <input type="text" class="form-control datepicker" name="masa_berlaku" id="masa_berlaku" value="" autocomplete="off">                                            
                                            </div>
                                   ...
                                   <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">6. Ringkasan Isi Surat</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea class="form-control" name="ringkasan_isi_surat" id="ringkasan_isi_surat" rows="5" autocomplete="off"><?php  echo $klasifikasi_lainnya;?></textarea>
      ...
      <!--  <script type="text/javascript" src="<?=base_url('backend/')?>js/plugins/jquery/jquery-ui.min.js"></script>-->
		...
		<script type="text/javascript">
			$("#batal").click(function() {
				  window.location.href = "<?php echo base_url('surat_penting')?>";
			});
        </script>
