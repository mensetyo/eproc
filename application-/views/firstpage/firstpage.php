...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?=base_url('frontend/')?>css/revolution-slider/extralayers.css" media="screen" />
        <link rel="stylesheet" type="text/css" href="<?=base_url('frontend/')?>css/revolution-slider/settings.css" media="screen" />
   ...
   <?php $this->load->view('include/frontend/header')?>
                    ...
                    <div class="banner">
                        ...
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="1" data-masterspeed="500"  data-saveperformance="on">
                                <img src="<?=base_url('frontend/')?>img/backgrounds/bg-2.jpg" />
                                ...
                                <div class="tp-caption lft customout rs-parallaxlevel-0"
                                    ...
                                    style="z-index: 2;">
                                    <img src="<?=base_url('frontend/')?>assets/slider-layers/atlant-title.png" alt="Atlant"/>
                                </div>
                                ...
                                <div class="tp-caption lft customout rs-parallaxlevel-0"
                                    ...
                                    data-endelementdelay="0.1"
                                    style="z-index: 3;">
                                    <img src="<?=base_url('frontend/')?>assets/slider-layers/atlant_monitor.png" alt="Atlant"/>
                                </div>
                                ...
                                <div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-endelementdelay="0.1"
                                    style="z-index: 4;">
                                    <img src="<?=base_url('frontend/')?>assets/slider-layers/atlant_responsive.png" alt="Atlant"/>
                                </div>
                                ...
                                <div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-endelementdelay="0.1"
                                    style="z-index: 5;">
                                    <img src="<?=base_url('frontend/')?>assets/slider-layers/atlant_tempalte.png" alt="Atlant"/>
                                </div>

                            </li>

                            <li data-transition="fade" data-slotamount="1" data-masterspeed="700" >
                                <img src="<?=base_url('frontend/')?>assets/video/video_typing_cover.jpg"  alt="video_typing_cover"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                                ...
                                <div class="tp-caption tp-fade fadeout fullscreenvideo"
                                    ...
                                    <video class="" preload="none" width="100%" height="100%" poster="assets/video/video_typing_cover.jpg">
                                        <source src='<?=base_url('frontend/')?>assets/video/computer_typing.mp4' type='video/mp4'/>
                                        <source src='<?=base_url('frontend/')?>assets/video/computer_typing.webm' type='video/webm'/>
                                    </video>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="<?=base_url('frontend/')?>assets/slider-layers/second_1.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="<?=base_url('frontend/')?>assets/slider-layers/second_2.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="<?=base_url('frontend/')?>assets/slider-layers/second_3.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="<?=base_url('frontend/')?>assets/slider-layers/second_4.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="<?=base_url('frontend/')?>assets/slider-layers/second_5.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="<?=base_url('frontend/')?>assets/slider-layers/second_6.png"/>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 this-animate" data-animate="fadeInLeft">
                                ...
                                <div class="block this-animate" data-animate="fadeInLeft">
                                    <img src="<?=base_url('frontend/')?>assets/atlant_technologies.png" class="img-responsive"/>
                                </div>
                            </div>
                            <div class="col-md-4 this-animate text-center" data-animate="fadeInRight">
                                <img src="<?=base_url('frontend/')?>assets/atlant_responsive.png" class="img-responsive-mobile"/>
                            </div>
                        </div>
        ...
        <script type="text/javascript" src="<?=base_url('frontend/')?>js/plugins/revolution-slider/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="<?=base_url('frontend/')?>js/plugins/revolution-slider/jquery.themepunch.revolution.min.js"></script>

        <script type="text/javascript" src="<?=base_url('frontend/')?>js/actions.js"></script>
        <script type="text/javascript" src="<?=base_url('frontend/')?>js/slider.js"></script>
        <!-- ./page scripts -->
    </body>
</html>
