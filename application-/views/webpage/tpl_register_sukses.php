...
<form id="alumniForm"  action="#" method="post" enctype="multipart/form-data">
    <table align="left" border="0">
		...
		<tr>
			...
			<td>
                               <select  id="tipe_perusahaan" name="tipe_perusahaan" class="required" title="" disabled />
			...
			<td>
                       <input name="nama_perusahaan" class="required" title="" size="40" type="text" disabled />
			</td>
		</tr>
		...
		<tr>
			...
			<td>3. Telephone *</td>
			<td>
                 <input name="tlp" id="tlp" class="required" title="" size="40" type="text" disabled />
			</td>
		</tr>
		...
		<tr>
			...
			<td>4. Email *</td>
			<td>
                 <input name="email" id="email" class="required" title="" size="40" type="text" disabled  />
			</td>
		</tr>
		...
		<tr>
			...
			<td>5. KTP Pemilik *</td>
			<td>
                  <input name="ktp" id="ktp" class="required" title="" size="40" type="file" disabled />
			</td>
		</tr>
			...
			<td>6. SIUP *</td>
			<td>
                  <input name="siup" id="siup" class="required" title="" size="40" type="file" disabled />
			</td>
		</tr>
			...
			<td>7. TDP *</td>
			<td>
                  <input name="tdp" id="tdp" class="required" title="" size="40" type="file" disabled />
			</td>
		</tr>
		<tr>
                     <td>&nbsp;</td>
			<td>8. NPWP *</td>
			<td>
                   <input name="npwp" id="npwp" class="required" title="" size="40" type="file" disabled />
			</td>
		</tr>
				<tr>
                    <td width="100">&nbsp;</td>
