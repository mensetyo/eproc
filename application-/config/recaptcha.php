...
#$config['recaptcha_sitekey'] = "6LeY-VcUAAAAANVxB0LkXfUnZRQjQON6YBAKWFkd";

$config['recaptcha_sitekey'] = "6Lea-VcUAAAAAJKmnHhbwSuQGHyEK58d-1qPgqyQ";
$config['recaptcha_secretkey'] = "6Lea-VcUAAAAAHofxw8IzW3pCWK-ooV_J4piTQfd";

#$config['recaptcha_secretkey'] = "6LeY-VcUAAAAAPBTog05-DiPHz5MiWtgpQJmJrbt";
$config['lang'] = "";